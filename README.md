...
CLI tool that converts [Automerge rich text](https://automerge.org/docs/reference/documents/rich-text/) to/from other formats, leveraging [Pandoc](https://pandoc.org/). Built using [Haskell](https://www.haskell.org/).
